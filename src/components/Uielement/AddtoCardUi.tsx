      ...
      >
        ...
        >
          {addCart.length > 0 ? (
            ...
            <p className="text-center font-bold text-3xl pt-6">Empty Cart</p>
          )}
        ...
        <div
          onClick={clearAll}
          className=" cursor-pointer text-[#6d6d6d] text-xs text-center py-3"
        >
        ...
        <div className="mt-4 cursor-pointer text-center">
          <button
            onClick={PayNow}
            className="px-10 py-2 bg-[#298BFD] rounded-[20px] text-white text-sm"
          >
            Pay Now
          </button>
        </div>
